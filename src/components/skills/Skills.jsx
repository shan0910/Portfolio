        ...
        <div className="s" id="skills">
            ...
            <Fade left delay={800}>
                <div className="s2-wrapper" style={{border:darkMode?"0px solid rgb(90, 90, 90)":"3px solid rgb(54, 54, 54)"}}>
                    ...
                    <li className="p-item"><a href="https://shan0910.github.io/mankav/" style={{color:darkMode?"black":"black"}}>ML integrated Hospital Website</a></li>
            ...
            <div className="s-right">
                <div className="resume">
                    <a href="https://drive.google.com/file/d/1zU3pBy_PEDpzTjws3RwACC3iPUDp9E0Y/view?usp=sharing"><img src={Resume} className="resume-img" /></a>
                </div> 
